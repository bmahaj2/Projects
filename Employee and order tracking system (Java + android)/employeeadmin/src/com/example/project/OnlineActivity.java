...
public class OnlineActivity extends Activity {
 ...
 MyBroadcast br;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		sp=(Spinner)findViewById(R.id.onspinner);
...
//		registerReceiver(br,infilter);
		IntentFilter inf = new IntentFilter("dept");
	 ...
	 public void go(View v)
		{
		 ...
		 Intent in1 = new Intent(getApplicationContext(),OnlineActivity1.class);
			startActivity(in1);
		}
}
